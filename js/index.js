!(function ($) {
  ...
  $(window).scroll(function () { 
     if($(window).scrollTop() > 150){
       $(".navbacr").addClass("shadow nav_bar_color fixed-top");

     }
     else{
       $(".navbcar").removeClass("shadow nav_bar_color fixed-top");
      }
  });
  ...
  $("#play_button").click(function () { 
    ...
    $('#frame').removeClass('display_none');
   $('#frame').addClass('display');
  $("#close_ve").click(function () { 
